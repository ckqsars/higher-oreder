...
def main():
    file = '/home/ckqsars/workspace/high_order/data/graph3.txt'
    outfile = '/home/ckqsars/workspace/high_order/result/result_12/result_node.txt'
    fr = open(file)
    fp = open(outfile, 'w+')
    dictnode = {}
    dictmotif = {}
    ...
    for i in range(20):
        for index in oldNodesValue:
            ...
            newNodeValue[index] = 1.0 * sumdata / nodesValue0[index] / max(oldMotifsValue.items(), key=lambda x: x[1])[
                1]
