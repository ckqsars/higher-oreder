...
if __name__ == "__main__":
    ...
    delimiter = '\t'
    data = '/home/ckqsars/workspace/high_order/result/result_10/result_motif.txt'
    out = '/home/ckqsars/workspace/high_order/result/result_10/motif_result_kmeans.txt'
