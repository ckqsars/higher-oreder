...
def main():
    ...
    outfile = '/home/ckqsars/workspace/high_order/result/food_web/result_temp.txt'
    motifile = "/home/ckqsars/workspace/high_order/result/food_web/motif_result"
    fr = open(file)
    fp = open(outfile, 'w+')
    fp2 = open(motifile, 'w+')
    dictnode = {}
